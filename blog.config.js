...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '子云逸', // 您的昵称 例如 cnsywq
  BIO: process.env.NEXT_PUBLIC_BIO || '一个职业培训学校校长🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.cnsywq.top', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个特种设备安全专家, Hi，我是一个职业培训学校校长,Hi，我是一个蓝领职业规划者,欢迎来到我的博客🎉',
